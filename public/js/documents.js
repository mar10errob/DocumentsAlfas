function existDocuments () {
    var docuents = localStorage.getItem('documents');
	var usersDocuments = documents.split('$');
...
function selectDocument (titleOfDocument) {
	...
	window.location.href = "../../resources/views/editor.php";
}
...
function deleteDocument (userDoc) {
	...
	window.location.href = "../../resources/views/documents.php";
}
