...
function login () {
    ...
    if (username.value == user[1] && password.value == user[3]) {
        ...
        window.location = "../../resources/views/documents.php";
    } else {
...
function isAuthenticated ()
{
	if (localStorage.getItem('authenticate') == 'true') {
		...
		if (error.style.top = "-100%") {
			...
			setTimeout(function(){window.location = "../../resources/views/login.php";},4000);
		 }
	}
}
...
function isntAuthenticated () 
{
	if (localStorage.getItem('authenticate') == 'true') {
		...
		if (error.style.top = "-100%") {
			...
			setTimeout(function(){ error.style.top = "-100%"; },3500);	 	
			setTimeout(function(){ window.location = "../../resources/views/documents.php"; },4000);
		 }
	}
}
...
function register () 
{
	...
	if (contenedor.style.top= "-100%" && (password_confirm == password)) {
		...
		setTimeout(function(){
			...
			window.location = "../../resources/views/login.php";},3500
		);
	}
}
...
function nuevo ()
{
	window.location ="../../resources/views/editor.php";
}
